            ...
            {user ? <div className="container py-4 mx-auto flex items-center">
                ...
                <div className="container flex justify-end">
                    ...
                    <div className='flex flex-col px-2 '>
                        ...
                        <div className='bg-midblue border-b border-l border-r border-gray-300 w-8 lg:w-24 text-center rounded-b lg:p-1'>
                    ...
                    <div className='flex flex-col px-2'>
                        <div className='bg-crossmaskblue border-t border-l border-r border-gray-500 w-12 lg:w-24 text-center rounded-t'>
                        <p className='text-xs lg:text-lg text-lightblue'>% OPEN</p>
                        </div>
                        <div className='bg-midblue border-b border-l border-r border-gray-300 w-12 lg:w-24 text-center rounded-b lg:p-1'>
                    ...
                    <nav>
                        <div className="flex items-center justify-center px-2 lg:px-6 flex-col gap-3">
